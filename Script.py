...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>✯ ᴍʏ ɴᴀᴍᴇ: {}
✯ Lɪʙʀᴀʀʏ: <a href='docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a>
✯ Lᴀɴɢᴜᴀɢᴇ: <a href='www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 𝟹</a>
✯ DᴀᴛᴀBᴀsᴇ: <a href='www.mongodb.com'>ᴍᴏɴɢᴏ ᴅʙ</a>
✯ Bᴏᴛ Sᴇʀᴠᴇʀ: ᴋᴏʏᴇʙ
✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: 𝚟𝟸.𝟽.𝟷 [ 𝚂ᴛᴀʙʟᴇ ]</b>"""

    SOURCE_TXT = """
<b>Hᴇʏ, Tʜɪs ɪs ᴀ Oᴘᴇɴ Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ.

Tʜɪs Bᴏᴛ ʜᴀs Lᴀᴛᴇsᴛ ᴀɴᴅ Aᴅᴠᴀɴᴄᴇᴅ Fᴇᴀᴛᴜʀᴇs⚡️
<a href='https://github.com/Kushalhk/AutoFilter'>📥 ᴄʟɪᴄᴋ ʜᴇʀᴇ 📥</a></b>
"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/haris_garage)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
